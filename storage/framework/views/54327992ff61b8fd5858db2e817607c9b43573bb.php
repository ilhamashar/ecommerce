...
$(document).ready(function(e) {
    ...
    //datepickerTimeline
	$(document).on('focus','.datepickerTimeline',function(){
		$(this).datepicker({
		  autoclose: true,
		  format: 'dd/mm/yyyy'
		});
...
$(document).on('click', '.update-timeline	', function(e){
	
	$('.timline-added').hide();
	$('.timline-updated').hide();
	$('.timline-deleted').hide();
	...
	$.ajax({
		url: '<?php echo e(URL::to("admin/updateTimeline")); ?>',
		type: "POST",
		data: formData,
		//async: false,
		success: function (res) {
				$('.timline-updated').show();
				$(".contentTimeline").html(res);
		},
	});
...
$(document).on('click', '.add-timeline', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("admin/addTimeline")); ?>',
		type: "POST",
		data: formData,
		//async: false,
		success: function (res) {
...
$(document).on('click', '.delete-timeline', function(){
	var timelines_id = $(this).attr('timelines_id');
	$('#timelines_id').val(timelines_id);
...
$(document).on('click', '#deleteTimeline', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("admin/deleteTimeline")); ?>',
		type: "POST",
		data: formData,
		//async: false,
		success: function (res) {
				$("#deleteTimelineModal").modal('hide');
				$('.timline-deleted').show();
				$(".contentTimeline").html(res);
		},
	});
