...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> Options <small>Listing All Options...</small> </h1>
    <ol class="breadcrumb">
        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
            	<a href="addAttributes" type="button" class="btn btn-block btn-primary">Add New Options</a>
            </div>
          </div>
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="deleteAttributeModalLabel">Delete Option</h4>
		  </div>
		  ...
		  <div class="modal-footer">
			...
			<button type="submit" class="btn btn-primary" id="deleteAttribute">Delete Option</button>
		  </div>
		  <?php echo Form::close(); ?>
		</div>
	  </div>
    ...
    <div class="modal fade" id="productListModal" tabindex="-1" role="dialog" aria-labelledby="productListModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="productListModalLabel">Associated Products</h4>
          </div>
          <div class="modal-body">	
          	<p><strong>These products are associated with current option. So, this option cannot be delete.</strong></p>					
    ...
    <div class="modal fade" id="productListModalValue" tabindex="-1" role="dialog" aria-labelledby="productListModalValueLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="productListModalValueLabel">Associated Products</h4>
          </div>
          <div class="modal-body">	
          	<p><strong>These products are associated with current value. So, this value cannot be delete.</strong></p>					
	...
	<div class="modal fade" id="deleteValueModal" tabindex="-1" role="dialog" aria-labelledby="deleteValueModalLabel">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			<h4 class="modal-title" id="deleteValueModalLabel">Delete Value</h4>
		  </div>
		  ...
		  <div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
			<button type="button" class="btn btn-primary" id="deleteAttribute">Delete Option</button>
		  </div>
		  <?php echo Form::close(); ?>
		</div>
	  </div>
