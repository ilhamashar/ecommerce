                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                          ...
                          <?php endif; ?>
                            ...
                            <hr>
                            <h4><?php echo e(trans('labels.defaultNotification')); ?></h4>
                            <hr>
                            ...
                            <div class="form-group">
                              ...
                              <select name="default_notification" id="default_notification" class="form-control">
                              	<option <?php if($result['setting'][0]->default_notification == 'fcm'): ?>
                                        selected
                                    <?php endif; ?>
                                 value="fcm"> <?php echo e(trans('labels.fcm')); ?></option>
                              	<option <?php if($result['setting'][0]->default_notification == 'onesignal'): ?>
                                        selected
                                    <?php endif; ?>
                                 value="onesignal"> <?php echo e(trans('labels.onesignal')); ?></option>                                         
                               </select>                                
                            ...
                            <div class="onesignal_content" <?php if($result['setting'][0]->default_notification == 'onesignal'): ?>
                                    style="display: block;"
                                <?php endif; ?> style="display: none;">
                            <hr>
                            <h5><?php echo e(trans('labels.PushNotificationOnesignal')); ?> </h5>
                            <hr>
                            <div class="form-group">
                              <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.OnesignalAppid')); ?></label>
                              <div class="col-sm-10 col-md-4">
                                <?php echo Form::text('onesignal_app_id',  $result['setting'][0]->onesignal_app_id, array('class'=>'form-control', 'id'=>'onesignal_app_id')); ?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10 col-md-4">
                                <?php echo Form::text('onesignal_sender_id',  $result['setting'][0]->onesignal_sender_id, array('class'=>'form-control', 'id'=>'onesignal_app_id')); ?>
                            ...
                            <div class="fcm_content" <?php if($result['setting'][0]->default_notification == 'fcm'): ?>
                                        style="display: block;"
                                    <?php endif; ?> style="display: none;">
                             <hr>
